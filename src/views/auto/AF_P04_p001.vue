...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      store.ui.header.setDepthActive(() => 'auto004');
    });
  ...
  <PageContents size="full">
      ...
      <div :class="$style['product-top__contents']">
        <div :class="$style['product-top__head']">
          ...
          <p :class="$style['product-top__main-text']">
            차량 대금은 금융사에서 지급,<br />
            손님은 해당 금액을 분할 납부하는 금융상품 입니다
          </p>
        </div>

        <div :class="$style['product-top__image']">
          <img src="@/assets/images/contents/img-auto-loan.png" alt="" />
        </div>
          ...
          <ul :class="$style['product-detail__list']">
            ...
            <li :class="$style['product-detail__item']">
              ...
              <div :class="$style['product-detail__block']">
                ...
                <div :class="$style['product-detail__desc']">12 ~ 72개월</div>
              </div>
            </li>
          </ul>
        </div>
    ...
    <div class="wide-wrap row-margin-block">
      <UiTab>
        ...
        >
          <NavTabButton link="AF_P04_p001_tab001">상품안내</NavTabButton>
          <NavTabButton link="AF_P04_p001_tab002">진행절차</NavTabButton>
          <NavTabButton link="AF_P04_p001_tab003">유의사항</NavTabButton>
        </NavTab>

        <!-- 상품안내 -->
        <UiTabPanel name="AF_P04_p001_tab001">
          ...
          <div class="row-margin-block-small">
            ...
            <section class="row-margin-contents">
              ...
              <div class="text-title-2">약정금리 + 3.00%</div>
        ...
        <!-- 진행절차 -->
        <UiTabPanel name="AF_P04_p001_tab002">
                ...
                <div :class="$style['step__inner']">
                  <div :class="$style['step__contents']">
                    ...
                    <p :class="$style['step__text']">
                      홈페이지에서<br />
                      <strong>신차오토론 상담</strong>을 신청합니다.
                    </p>
                  </div>
        ...
        <!-- 유의사항 -->
        <UiTabPanel name="AF_P04_p001_tab003">
          <ul
            :class="[
              $style['basic-list'],
              $style['basic-list--medium'],
        ...
        <ul :class="[$style['basic-list'], 'row-margin-contents']">
          <li :class="$style['basic-list__item']">
            <div :class="$style['basic-list__symbol']"></div>
            <div :class="$style['basic-list__content']">
              준법심의필 23-154 (2023.05.22~2024.05.21)
            </div>
          </li>
          <li :class="$style['basic-list__item']">
            <div :class="$style['basic-list__symbol']"></div>
            <div :class="$style['basic-list__content']">
              여신금융협회 심의필 제 2023-C1h-05741호 (2023.05.22~2024.05.21)
            </div>
          </li>
        </ul>
      </UiTab>
...
@import '@/assets/scss/views/auto/AF_P04_p001.scss';
</style>
