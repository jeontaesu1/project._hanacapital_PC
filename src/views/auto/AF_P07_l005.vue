    ...
    <ModalPopup>
      ...
      <KeyValue>
        <KeyValueItem>
          <KeyValueTitle>
            <div class="flex-box">
              <div class="flex-box__cell">렌트료 합계</div>
              <div class="flex-box__cell flex-box__cell--small">
                <BasicTooltip placement="bottom" type="popup">
                  ...
                  <template v-slot:contents>
                    <section :class="$style['tooltip-section']">
                      ...
                      <p :class="$style['tooltip-section__text']">
                        “잔여기간(00개월)×월 렌트료(0원)”으로 렌트료 총 납부금액
                        0원입니다.
                      </p>
                    </section>
                  </template>
        ...
        <KeyValueItem>
          <KeyValueTitle>
            <div class="flex-box">
              <div class="flex-box__cell">만기 인수 시 납부금액</div>
              <div class="flex-box__cell flex-box__cell--small">
                <BasicTooltip placement="bottom" type="popup">
                  <IconTooltip :class="$style['tooltip-icon']" />
                  <span class="for-a11y">(도움말)</span>
      ...
      <KeyValue>
        <KeyValueItem>
          <KeyValueTitle>
            <div class="flex-box">
              <div class="flex-box__cell">보증금</div>
              <div class="flex-box__cell flex-box__cell--small">
                <BasicTooltip type="popup">
                  ...
                  <template v-slot:contents>
                    <section :class="$style['tooltip-section']">
                      <h3 :class="$style['tooltip-section__title']">보증금</h3>
                      <p :class="$style['tooltip-section__text']">
                        렌트사에 예치해 놓은 금액(반환 시 환급)
                      </p>
                    </section>
                  </template>
                </BasicTooltip>
        ...
        <KeyValueItem>
          <KeyValueTitle>
            <div class="flex-box">
              <div class="flex-box__cell">잔여선납금</div>
              <div class="flex-box__cell flex-box__cell--small">
                <BasicTooltip type="popup">
                  <IconTooltip :class="$style['tooltip-icon']" />
                  <span class="for-a11y">(도움말)</span>
        ...
        <KeyValueItem>
          <KeyValueTitle>
            <div class="flex-box">
              <div class="flex-box__cell">잔존가치 (VAT포함)</div>
              <div class="flex-box__cell flex-box__cell--small">
                <BasicTooltip type="popup">
                  <IconTooltip :class="$style['tooltip-icon']" />
                  <span class="for-a11y">(도움말)</span>
        ...
        <KeyValueItem>
          <KeyValueTitle>
            <div class="flex-box">
              <div class="flex-box__cell">월 렌트료</div>
              <div class="flex-box__cell flex-box__cell--small">
                <BasicTooltip type="popup">
                  <IconTooltip :class="$style['tooltip-icon']" />
                  <span class="for-a11y">(도움말)</span>
...
@import '@/assets/scss/views/auto/AF_P07_l005.scss';
</style>
