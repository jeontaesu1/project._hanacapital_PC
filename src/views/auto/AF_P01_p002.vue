  ...
  <PageContents>
    ...
    <div>
      ...
      <section class="row-margin-block-small">
        ...
        <FormList>
          ...
          <FormListItem
            titleText="차종"
            target="#AF_P01_p002_carNameError"
            :selectOnly="true"
          >
              ...
              <InputBlock :error="state.carNameError">
                <InputBlockCell :flexible="true">
                  <BasicSelect
                    ...
                    title="차종"
                    inputId="AF_P01_p002_carNameError"
                  />
                </InputBlockCell>
              </InputBlock>
              <FormInvalidMessage>Error Message</FormInvalidMessage>
                  ...
                  <ul :class="$style['option-list__list']">
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_model_001"
                          id="AF_P01_p002_model_001_001"
                          :full="true"
                        >
                          <RadioButtonObject />
                          <RadioButtonLabelText>
                ...
                <div :class="$style['option-list']">
                  <ul :class="$style['option-list__list']">
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_model"
                          id="AF_P01_p002_model_002_001"
                          :full="true"
                        >
                          <RadioButtonObject />
                          <RadioButtonLabelText>
                ...
                <div :class="$style['option-list']">
                  <ul :class="$style['option-list__list']">
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_model_003"
                          id="AF_P01_p002_model_003_001"
                          :full="true"
                        >
                          <RadioButtonObject />
                          <RadioButtonLabelText>
              ...
              <div :class="$style['select-list__contents']">
                ...
                <BasicBox theme="tertiary" className="row-margin-contents">
                  <FormList>
                    <FormListItem
                      titleText="기타옵션"
                      target="#AF_P01_p002_extraOption"
                    >
                    ...
                    <FormListItem
                      titleText="금액"
                      target="#AF_P01_p002_extraOptionPrice"
                    >
                        ...
                        <InputBlock :error="state.extraOptionPriceError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              ...
                              pattern="\d*"
                              title="금액"
                              id="AF_P01_p002_extraOptionPrice"
                            />
                          </InputBlockCell>
              ...
              <div :class="$style['select-list__contents']">
                <div :class="$style['option-list']">
                  <ul :class="$style['option-list__list']">
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_exteriorColor"
                          id="AF_P01_p002_exteriorColor_001"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_exteriorColor"
                          id="AF_P01_p002_exteriorColor_002"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_exteriorColor"
                          id="AF_P01_p002_exteriorColor_003"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_exteriorColor"
                          id="AF_P01_p002_exteriorColor_004"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_exteriorColor"
                          id="AF_P01_p002_exteriorColor_005"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                ...
                <BasicBox theme="tertiary" className="row-margin-contents">
                  <FormList>
                    <FormListItem
                      titleText="기타외장색상"
                      target="#AF_P01_p002_extraExteriorColor"
                    >
                      <FormInvalid :error="state.extraExteriorColorError">
                        <InputBlock :error="state.extraExteriorColorError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="기타외장색상"
                              id="AF_P01_p002_extraExteriorColor"
                            />
                          </InputBlockCell>
                        </InputBlock>
                        <FormInvalidMessage>Error Message</FormInvalidMessage>
                    ...
                    <FormListItem
                      titleText="금액"
                      target="#AF_P01_p002_extraExteriorPrice"
                    >
                        ...
                        <InputBlock :error="state.extraExteriorPriceError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              ...
                              pattern="\d*"
                              title="금액"
                              id="AF_P01_p002_extraExteriorPrice"
                            />
                          </InputBlockCell>
                          <template v-slot:innerRight>
                            <div class="text-body-1">원</div>
              ...
              <div :class="$style['select-list__contents']">
                <div :class="$style['option-list']">
                  <ul :class="$style['option-list__list']">
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_InteriorColor"
                          id="AF_P01_p002_InteriorColor_001"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_InteriorColor"
                          id="AF_P01_p002_InteriorColor_002"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_InteriorColor"
                          id="AF_P01_p002_InteriorColor_003"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_InteriorColor"
                          id="AF_P01_p002_InteriorColor_004"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                    ...
                    <li :class="$style['option-list__item']">
                      <div :class="$style['option-list__block']">
                        <RadioButton
                          name="AF_P01_p002_InteriorColor"
                          id="AF_P01_p002_InteriorColor_005"
                          :full="true"
                          align="center"
                        >
                          <RadioButtonObject />
                ...
                <BasicBox theme="tertiary" className="row-margin-contents">
                  <FormList>
                    <FormListItem
                      titleText="기타내장색상"
                      target="#AF_P01_p002_extraInteriorColor"
                    >
                      <FormInvalid :error="state.extraInteriorColorError">
                        <InputBlock :error="state.extraInteriorColorError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="기타내장색상"
                              id="AF_P01_p002_extraInteriorColor"
                            />
                          </InputBlockCell>
                        </InputBlock>
                        <FormInvalidMessage>Error Message</FormInvalidMessage>
                    ...
                    <FormListItem
                      titleText="금액"
                      target="#AF_P01_p002_extraInteriorPrice"
                    >
                        ...
                        <InputBlock :error="state.extraInteriorPriceError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              ...
                              pattern="\d*"
                              title="금액"
                              id="AF_P01_p002_extraInteriorPrice"
                            />
                          </InputBlockCell>
                          <template v-slot:innerRight>
                            <div class="text-body-1">원</div>
      ...
      <section class="row-margin-block-small">
        ...
        <div>
          <section class="row-margin-container-medium">
            ...
            <BoxCheckList :wrap="true" col="5">
              <BoxCheckListItem>
                <BoxCheck
                  :minSide="true"
                  name="AF_P01_p002_period"
                  id="AF_P01_p002_period001"
                >
          ...
          <section class="row-margin-container-medium">
            ...
            <BoxCheckList :wrap="true" col="4">
              <BoxCheckListItem>
                <BoxCheck
                  :minSide="true"
                  name="AF_P01_p002_deposit"
                  id="AF_P01_p002_deposit_001"
                >
          ...
          <section class="row-margin-container-medium">
            <h4 class="text-body-1 row-margin-item-group">정비서비스</h4>

            <BoxCheckList>
              <BoxCheckListItem>
                <BoxCheck
                  :minSide="true"
                  name="AF_P01_p002_maintenance"
                  id="AF_P01_p002_maintenance_001"
                >
              ...
              <BoxCheckListItem>
                <BoxCheck
                  :minSide="true"
                  name="AF_P01_p002_maintenance"
                  id="AF_P01_p002_maintenance_002"
                >
                  <BoxCheckLabel>정비포함</BoxCheckLabel>
                </BoxCheck>
              </BoxCheckListItem>
            </BoxCheckList>
          </section>
      ...
      <ul class="reset-list">
        <li class="row-margin-item-medium">
          <NoticeText
            >본 이용료에는 VAT포험 기준 금액이며, 자동차세, 보험료 등이 포함되어
            있습니다.</NoticeText
          >
        </li>
        <li class="row-margin-item-medium">
          <NoticeText
            >상기 견적은 제조사 차량가격 변동 및 렌트조건에 따라 변경될 수
            있으며, 렌트(상담)신청 시 정확한 견적확인이 가능합니다.</NoticeText
          >
        </li>
      </ul>
    ...
    <div>
      <section class="row-margin-block-small">
        ...
        <FormList>
          <FormListItem titleText="이름" target="#AF_P01_p002_name">
            <FormInvalid :error="state.nameError">
              <InputBlock :error="state.nameError">
                <InputBlockCell :flexible="true">
                  <BasicInput title="이름" id="AF_P01_p002_name" />
                </InputBlockCell>
              </InputBlock>
              <FormInvalidMessage>Error Message</FormInvalidMessage>
            </FormInvalid>
          ...
          <FormListItem titleText="휴대폰번호" target="#AF_P01_p002_phone">
...
@import '@/assets/scss/views/auto/AF_P01_p002.scss';
</style>
