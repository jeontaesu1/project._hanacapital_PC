    ...
    <div :class="$style['product-top']">
      <div :class="$style['product-top__contents']">
        <div :class="$style['product-top__head']">
          <h2 :class="$style['product-top__sub-text']">원큐다이렉트 오토론</h2>
        ...
        <div :class="$style['product-top__image']">
          <img src="@/assets/images/contents/img-direct-autoloan.png" alt="" />
        </div>
      ...
      <UiTab>
              ...
              <li :class="$style['step__item']">
                <div :class="$style['step__inner']">
                  <div :class="$style['step__contents']">
                    ...
                    <p :class="$style['step__text']">
                      신청하신<br />
                      <strong>대출심사 결과를</strong><br />
                      <strong>안내</strong>합니다.
                    </p>
                  </div>
                  <div :class="$style['step__icon']">
                    <IconContract />
              ...
              <li :class="$style['step__item']">
                <div :class="$style['step__inner']">
                  <div :class="$style['step__contents']">
                    ...
                    <p :class="$style['step__text']">
                      모바일을 통한<br />
                      <strong>온라인약정 작성 및 손님의</strong><br />
                      <strong>대출금을 지급</strong>합니다.
                    </p>
                  </div>
                  <div :class="$style['step__icon']">
                    <IconDeposit />
        ...
        <ul :class="[$style['basic-list'], 'row-margin-contents']">
          <li :class="$style['basic-list__item']">
            <div :class="$style['basic-list__symbol']"></div>
            <div :class="$style['basic-list__content']">
              준법심의필 22-1186 (2022.05.09~2023.05.08)
            </div>
          </li>
          <li :class="$style['basic-list__item']">
            <div :class="$style['basic-list__symbol']"></div>
            <div :class="$style['basic-list__content']">
              여신금융협회 심의필 제2022-C1h-03830호 (2022.05.09~2023.05.08)
            </div>
          </li>
        </ul>
      </UiTab>
...
@import '@/assets/scss/views/auto/AF_P05_p001_contents.scss';
</style>
