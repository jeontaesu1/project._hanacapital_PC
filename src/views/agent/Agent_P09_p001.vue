...
<template>
  <PageContents size="max">
    ...
    <SearchForm>
      ...
      <SearchFormList>
        <SearchFormItem>
          <template v-slot:key>매입요청일자</template>
          <div class="flex-box">
        ...
        <SearchFormItem>
          ...
          <div class="flex-box">
            <div class="flex-box__cell flex-box__cell--medium">
              <RadioButton
                name="Agent_P09_p001_status"
                id="Agent_P09_p001_status_001"
                theme="tertiary"
                :defaultChecked="true"
              >
                <RadioButtonObject />
            ...
            <div class="flex-box__cell flex-box__cell--medium">
              <RadioButton
                name="Agent_P09_p001_status"
                id="Agent_P09_p001_status_002"
                theme="tertiary"
              >
                <RadioButtonObject />
                <RadioButtonLabelText>정상</RadioButtonLabelText>
              </RadioButton>
            </div>
            <div class="flex-box__cell flex-box__cell--medium">
              <RadioButton
                name="Agent_P09_p001_status"
                id="Agent_P09_p001_status_003"
                theme="tertiary"
              >
                <RadioButtonObject />
                <RadioButtonLabelText>오류</RadioButtonLabelText>
              </RadioButton>
            </div>
            <div class="flex-box__cell flex-box__cell--medium">
              <RadioButton
                name="Agent_P09_p001_status"
                id="Agent_P09_p001_status_004"
                theme="tertiary"
              >
                <RadioButtonObject />
                <RadioButtonLabelText>보류</RadioButtonLabelText>
              </RadioButton>
            </div>
          </div>
        </SearchFormItem>
        ...
        <SearchFormItem>
          ...
          <div class="flex-box">
            <div class="flex-box__cell flex-box__cell--medium">
              <RadioButton
                name="Agent_P09_p001_type"
                id="Agent_P09_p001_type_001"
                theme="tertiary"
                :defaultChecked="true"
              >
                <RadioButtonObject />
...
@import '@/assets/scss/views/agent/Agent_P09_p001.scss';
</style>
