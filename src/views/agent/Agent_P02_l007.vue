...
export default {
  ...
  setup() {
    ...
    const byte = ref(0);
    const textarea = ref(
      '안녕하세요?\n하나캐피탈 할부 상담을 위한 서비스입니다.\n고객님의 할부 금융 상담을 위해 아래의 URL로 접속하여 진행 바랍니다.\nhttps://m.hanacapital.co.kr/drqd/index.hnc\n대단히 감사합니다.'
    );
    ...
    <ModalPopup size="large">
      <template v-slot:head>
        <ModalPopupHead>
          ...
          <PopupTitle>하나캐피탈 할부 상담 URL 발송</PopupTitle>
        </ModalPopupHead>
      </template>
...
@import '@/assets/scss/views/agent/Agent_P02_l007.scss';
</style>
