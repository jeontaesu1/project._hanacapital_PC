...
<template>
  <PageContents size="max">
    ...
    <SearchForm>
      ...
      <SearchFormList>
        <SearchFormItem>
          <template v-slot:key>매각요청일자</template>
          <div class="flex-box">
        ...
        <SearchFormItem>
          <template v-slot:key>SGI가입여부</template>
          <div class="flex-box">
            <div class="flex-box__cell flex-box__cell--medium">
              <RadioButton
                name="Agent_P09_p006_join"
                id="Agent_P09_p006_join_001"
                theme="tertiary"
                :defaultChecked="true"
              >
                <RadioButtonObject />
