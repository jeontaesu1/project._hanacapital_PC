...
<template>
  <PageContents size="max">
    ...
    <SearchForm>
      ...
      <SearchFormList>
        <SearchFormItem>
          <template v-slot:key>수납요청일자</template>
          <div class="flex-box">
        ...
        <SearchFormItem>
          ...
          <div class="flex-box">
            <div class="flex-box__cell flex-box__cell--medium">
              <RadioButton
                name="Agent_P09_p002_status"
                id="Agent_P09_p002_status_001"
                theme="tertiary"
                :defaultChecked="true"
              >
                <RadioButtonObject />
...
@import '@/assets/scss/views/agent/Agent_P09_p002.scss';
</style>
