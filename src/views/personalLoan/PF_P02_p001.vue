...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      store.ui.header.setDepthActive(() => 'personalLoan002');
    });
  ...
  <PageContents size="full">
    ...
    <div :class="$style['product-top']">
      <div :class="$style['product-top__contents']">
        <div :class="$style['product-top__head']">
          <h2 :class="$style['product-top__sub-text']">행복아파트론</h2>
    ...
    <div class="wide-wrap row-margin-block">
      <UiTab>
        ...
        >
          <NavTabButton link="PF_P02_p001_tab001">상품안내</NavTabButton>
          <NavTabButton link="PF_P02_p001_tab002">진행절차</NavTabButton>
          <NavTabButton link="PF_P02_p001_tab003">유의사항</NavTabButton>
        </NavTab>

        <!-- 상품안내 -->
        <UiTabPanel name="PF_P02_p001_tab001">
          ...
          <div class="row-margin-block-small">
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-title-2">
                내부 기준에 따라 행복아파트론으로 진행 불가 시,
                <span class="color-green font-weight-medium">아파트론</span>
                상품으로 자동전환되어 진행
              </p>
            </section>
          </div>
        ...
        <!-- 진행절차 -->
        <UiTabPanel name="PF_P02_p001_tab002">
        ...
        <!-- 유의사항 -->
        <UiTabPanel name="PF_P02_p001_tab003">
          <ul
            :class="[
              $style['basic-list'],
        ...
        <ul :class="[$style['basic-list'], 'row-margin-contents']">
          <li :class="$style['basic-list__item']">
            <div :class="$style['basic-list__symbol']"></div>
            <div :class="$style['basic-list__content']">
              준법심의필 22-1652(2022.10.17~2023.10.16)
            </div>
          </li>
          <li :class="$style['basic-list__item']">
            <div :class="$style['basic-list__symbol']"></div>
            <div :class="$style['basic-list__content']">
              여신금융협회심의필 제 2022-L1h-08904호(2022.10.17~2023.10.16)
            </div>
          </li>
        </ul>
      </UiTab>
...
@import '@/assets/scss/views/personalLoan/PF_P02_p001.scss';
</style>
