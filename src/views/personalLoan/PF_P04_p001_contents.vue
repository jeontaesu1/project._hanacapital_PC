    ...
    <div :class="$style['product-top']">
      <div :class="$style['product-top__contents']">
        <div :class="$style['product-top__head']">
          <h2 :class="$style['product-top__sub-text']">원큐자동차담보대출</h2>
          <p :class="$style['product-top__main-text']">
            내 차는 그대로 타면서 특별한도와 금리혜택까지!
          </p>
        </div>

        <div :class="$style['product-top__image']">
          <img src="@/assets/images/contents/img-1q-carloan.png" alt="" />
        </div>
    ...
    <div class="wide-wrap row-margin-block">
      ...
      <div>
              ...
              <div :class="$style['product-info__block']">
                ...
                <div :class="$style['product-info__contents']">
                  <div :class="$style['product-info__text']">
                    본인명의 차량 3개월 이상 소유자(출고 10년 이내로 제한)
                  </div>
                </div>
              </div>
            </li>
        ...
        <section class="row-margin-contents">
          ...
          <p class="text-title-2">당사 1순위 설정</p>
        ...
        <section class="row-margin-contents">
          ...
          >
            ...
            >
              <div :class="$style['basic-list__symbol']">-</div>
              <div :class="$style['basic-list__content']">
                1년 이상 : 중도상환원금 X 1% + 중도상환원금 X (중도상환수수료율
                - 1%) X 잔존기간/(대출기간 - 30일)
              </div>
            </li>
            <li
        ...
        <section class="row-margin-contents">
          ...
          <p class="text-body-3 color-gray font-weight-bold row-margin-small">
            (법정최고금리 연 20% 이내)
          </p>
        </section>
        <section class="row-margin-contents">
      ...
      <ul :class="[$style['basic-list'], 'row-margin-contents']">
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
          <div :class="$style['basic-list__content']">
            준법심의필 23-382 (2023.10.16 ~ 2024.10.15)
          </div>
        </li>
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
          <div :class="$style['basic-list__content']">
            여신금융협회 심의필 제2023-C1h-11547호 (2023.10.16 ~ 2024.10.15)
          </div>
        </li>
      </ul>
...
@import '@/assets/scss/views/personalLoan/PF_P04_p001_contents.scss';
</style>
