      ...
      <ModalPopup>
        <template v-slot:head>
          <ModalPopupHead>
            ...
            <PopupTitle>등기부등본 조회</PopupTitle>
          </ModalPopupHead>
        </template>
            ...
            <FormList>
              ...
              <FormListItem titleText="입력선택" :forceFocus="true">
                <FormInvalid :error="state.addressError001_004">
                  <BoxCheckList>
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="PF_P02_l002_address"
                        id="PF_P02_l002_address_001"
                      >
                ...
                >
                  ...
                  <!-- Case : '동 + 호' 선택 시  -->
                  <InputBlock :error="state.addressDetailError001">
                    <InputBlockCell :flexible="true">
                      <BasicInput
                        type="number"
                        pattern="\d*"
                    ...
                    <InputBlockCell>
                      <div class="text-body-1 font-weight-medium">동</div>
                    </InputBlockCell>
                    ...
                    <InputBlockCell>
                      <div class="text-body-1 font-weight-medium">호</div>
                    </InputBlockCell>
                  </InputBlock>
                  <!-- // Case : '동 + 호' 선택 시  -->
            ...
            <FormList>
              ...
              >
                <FormInvalid :error="state.addressError002_001">
                  <InputBlock
                    :error="state.addressError002_001"
                    :disabled="true"
                  >
                    <InputBlockCell :flexible="true">
                      <BasicInput
              ...
              <FormListItem titleText="입력선택" :forceFocus="true">
                <FormInvalid :error="state.addressError002_006">
                  <BoxCheckList>
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                  ...
                  <InputBlock
                    :error="state.addressError002_006"
                    :classNames="{ wrap: 'row-margin-item-group' }"
                  >
                    <InputBlockCell :flexible="true">
                      <BasicInput
                ...
                >
                  ...
                  <!-- Case : '동 + 호' 선택 시  -->
                  <InputBlock :error="state.addressDetailError002">
                    <InputBlockCell :flexible="true">
                      <BasicInput
                        type="number"
                        pattern="\d*"
        ...
        <ul class="reset-list">
          <li class="row-margin-contents-small">
            <BasicBox>
              <KeyValue>
                <KeyValueItem>
                  <KeyValueTitle>부동산고유번호</KeyValueTitle>
                  <KeyValueText>12345678901234</KeyValueText>
                </KeyValueItem>
                <KeyValueItem>
                  <KeyValueTitle>부동산 소재지번</KeyValueTitle>
                  <KeyValueText>
                    인천광역시 남동구 석석로333번길 33,<br />
                    제333동 제3층 제333호
                  </KeyValueText>
                </KeyValueItem>
                <KeyValueItem>
