...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      store.ui.header.setDepthActive(() => 'personalLoan007');
    });
  ...
  <PageContents size="full">
    ...
    <div :class="$style['product-top']">
      <div :class="$style['product-top__contents']">
        <div :class="$style['product-top__head']">
          <h2 :class="$style['product-top__sub-text']">사업자 주택담보대출</h2>
          <p :class="$style['product-top__main-text']">
            개인사업자를 대상으로 사업자금을 지원하는 담보대출
          </p>
        </div>

        <div :class="$style['product-top__image']">
          <img src="@/assets/images/contents/img-business-loan.png" alt="" />
        </div>
    ...
    <div class="wide-wrap row-margin-block">
      <UiTab>
        ...
        >
          <NavTabButton link="PF_P09_p001_tab001">상품안내</NavTabButton>
          <NavTabButton link="PF_P09_p001_tab002">진행절차</NavTabButton>
          <NavTabButton link="PF_P09_p001_tab003">유의사항</NavTabButton>
        </NavTab>

        <!-- 상품안내 -->
        <UiTabPanel name="PF_P09_p001_tab001">
          ...
          <div class="row-margin-block-small">
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-title-2">대출금액의 최저 120%이상 근저당 설정</p>
            </section>
          </div>
        </UiTabPanel>
        <!-- // 상품안내 -->
        ...
        <!-- 진행절차 -->
        <UiTabPanel name="PF_P09_p001_tab002">
        ...
        <!-- 유의사항 -->
        <UiTabPanel name="PF_P09_p001_tab003">
          <ul
            :class="[
              $style['basic-list'],
...
@import '@/assets/scss/views/personalLoan/PF_P09_p001.scss';
</style>
