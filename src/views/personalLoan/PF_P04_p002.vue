...
<template>
  <PageContents>
    ...
    >
      <FormListItem titleText="이름" target="#PF_P04_p002_name">
        <FormInvalid :error="state.nameError">
          <InputBlock :error="state.nameError">
            <InputBlockCell :flexible="true">
              <BasicInput title="이름" id="PF_P04_p002_name" />
            </InputBlockCell>
          </InputBlock>
      ...
      <FormListItem titleText="주민등록번호" target="#PF_P04_p002_id">
      ...
      <FormListItem titleText="연락처" target="#PF_P04_p002_phone">
        <FormInvalid :error="state.phoneError">
          <InputBlock :error="state.phoneError">
            <InputBlockCell :flexible="true">
              <BasicInput title="연락처" id="PF_P04_p002_phone" />
            </InputBlockCell>
          </InputBlock>
          <FormInvalidMessage>Error Message</FormInvalidMessage>
        </FormInvalid>
