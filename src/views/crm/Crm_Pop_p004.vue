...
<template>
  <UiLayer ref="layer" v-slot="layerSlotProps">
    <ModalPopup size="small">
      <template v-slot:head>
        <ModalPopupHead>
          <template v-slot:right>
            <PopupButton @click="layerSlotProps.close()" />
          </template>
          <PopupTitle>제휴사 추가</PopupTitle>
        </ModalPopupHead>
      </template>
      ...
      <div>
        <table class="table-type-01">
          ...
          <tbody>
            <tr>
              <td class="title required">제휴사명</td>
              <td><input type="text" /></td>
            </tr>

            <tr>
              <td class="title required">사업자번호</td>
              <td>
                <input type="text" />
              </td>
            </tr>
            ...
            <tr>
              <td class="title required">관리자 ID</td>
              <td>
                  ...
                  <div class="flex-box__cell flex-1">
                    ...
                    >
                      <template v-slot:bottom>
                        ...
                        <FormHelpText>신규등록 가능합니다. </FormHelpText>
                      </template>
                    </SimpleInput>
                  </div>
            ...
            <tr>
              <td class="title required">관리자 이름</td>
              <td>
                <input type="text" />
              </td>
            </tr>
            ...
            <tr>
              <td class="title required">관리자 연락처</td>
              <td>
                <input type="text" />
              </td>
            </tr>
