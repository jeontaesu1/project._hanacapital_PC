...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      store.ui.header.setActive(() => 'lmBlog001');
    });
    ...
    <div class="container">
      <div class="search-container">
        ...
        <div class="btn-container">
          <button class="btn btn-primary btn-search btn-middle">검색</button>
        </div>
      </div>
...
@import '@/assets/scss/views/lmBlog/LM_P02_p001.scss';
</style>
