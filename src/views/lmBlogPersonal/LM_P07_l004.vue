...
<template>
  <UiLayer ref="layer" v-slot="layerSlotProps">
    <ModalPopup>
      ...
      <FormList>
        <FormListItem titleText="이름" target="#LM_P07_l004_name">
          <FormInvalid :error="state.nameError">
            <InputBlock :error="state.nameError">
              <InputBlockCell :flexible="true">
                <BasicInput title="이름" id="LM_P07_l004_name" />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem titleText="휴대폰번호" target="#LM_P07_l004_phone">
          <FormInvalid :error="state.phoneError">
            <InputBlock :error="state.phoneError">
              <InputBlockCell :flexible="true">
                <BasicInput title="휴대폰번호" id="LM_P07_l004_phone" />
              </InputBlockCell>
            </InputBlock>
            <FormInvalidMessage>Error Message</FormInvalidMessage>
          </FormInvalid>
...
@import '@/assets/scss/views/lmBlog/LM_P07_l004.scss';
</style>
