...
<template>
  <PageContents>
    <PageHead>
      <PageHeadRow>
        <PageTitle align="left">SMS안내 수신/변경</PageTitle>
    ...
    >
      <BoxCheckListItem>
        <BoxCheck
          name="MI_P00_p008_type"
          id="MI_P00_p008_type_001"
          :defaultChecked="true"
        >
      ...
      <BoxCheckListItem>
        <BoxCheck name="MI_P00_p008_type" id="MI_P00_p008_type_002">
    ...
    <section>
      ...
      >
        <BoxCheckListItem>
          <BoxCheck
            name="MI_P00_p008_method"
            id="MI_P00_p008_method_001"
            :defaultChecked="true"
          >
        ...
        <BoxCheckListItem>
          <BoxCheck name="MI_P00_p008_method" id="MI_P00_p008_method_002">
            <BoxCheckLabel>공동인증서</BoxCheckLabel>
          </BoxCheck>
        </BoxCheckListItem>
        <BoxCheckListItem>
          <BoxCheck name="MI_P00_p008_method" id="MI_P00_p008_method_003">
      ...
      <div>
                ...
                <ul :class="$style['agree-list__list']">
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree001_001"
                        :classNames="{
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree001_002"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree001_003"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree001_004"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
        ...
        <FormList :classNames="{ wrap: 'row-margin-contents' }">
          <FormListItem
            titleText="휴대폰번호"
            target="#MI_P00_p008_phone001_telecom"
          >
              ...
              <InputBlock :error="state.phone001Error">
                <InputBlockCell>
                  <BasicSelect
                    ...
                    title="통신사"
                    inputId="MI_P00_p008_phone001_telecom"
                    :classNames="{
          ...
          <FormListItem
            ...
            target="#MI_P00_p008_phone001_code"
          >
      ...
      <div>
              ...
              <div :class="$style['agree-list__depth-contents']">
                <ul :class="$style['agree-list__list']">
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree002_001"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree002_002"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree002_003"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="MI_P00_p008_phoneAgree002_004"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
        ...
        <FormList>
          <FormListItem
            titleText="휴대폰번호"
            target="#MI_P00_p008_phone002_telecom"
          >
              ...
              <InputBlock :error="state.phone002Error">
                <InputBlockCell>
                  <BasicSelect
                    ...
                    title="통신사"
                    inputId="MI_P00_p008_phone002_telecom"
                    :classNames="{
                      wrap: 'input-width-telecom',
                    }"
                  />
          ...
          <FormListItem
            titleText="인증번호"
            titleOptionalText="(6자리)"
            target="#MI_P00_p008_phone002_code"
          >
      ...
      <div>
        <FormList>
          <FormListItem titleText="이름" target="#MI_P00_p008_name">
            <FormInvalid :error="state.nameError">
              <InputBlock :error="state.nameError">
                <InputBlockCell :flexible="true">
                  <BasicInput title="이름" id="MI_P00_p008_name" />
                </InputBlockCell>
              </InputBlock>
              <FormInvalidMessage>Error Message</FormInvalidMessage>
            </FormInvalid>
          ...
          <FormListItem titleText="주민등록번호" target="#MI_P00_p008_id">
      ...
      <div>
        ...
        <FormList>
          <FormListItem titleText="법인명" target="#MI_P00_p008_businessName">
            <FormInvalid :error="state.businessNameError">
              <InputBlock :error="state.businessNameError">
                <InputBlockCell :flexible="true">
                  <BasicInput title="법인명" id="MI_P00_p008_businessName" />
                </InputBlockCell>
              </InputBlock>
              <FormInvalidMessage>Error Message</FormInvalidMessage>
            </FormInvalid>
          ...
          <FormListItem
            ...
            target="#MI_P00_p008_BusinessLicense"
          >
              ...
              <InputBlock :error="state.businessLicenseError">
                <InputBlockCell :flexible="true">
                  <BasicInput
                    ref="license"
                    title="사업자등록번호 (10자리)"
                    id="MI_P00_p008_BusinessLicense"
                  />
                </InputBlockCell>
              </InputBlock>
              <FormInvalidMessage>Error Message</FormInvalidMessage>
          ...
          <FormListItem
            titleText="법인번호"
            target="#MI_P00_p008_businessNumber"
          >
      ...
      <div>
        <FormList>
          <FormListItem titleText="카드번호" target="#MI_P00_p008_cardNumber1">
          ...
          <FormListItem titleText="유효기간" target="#MI_P00_p008_cardDate1">
          ...
          <FormListItem
            ...
            target="#MI_P00_p008_cardPassword"
          >
...
@import '@/assets/scss/views/onlineBranch/MI_P00_p008.scss';
</style>
