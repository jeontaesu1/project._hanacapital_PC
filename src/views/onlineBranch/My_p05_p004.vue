  ...
  <PageContents>
    ...
    <PageHead>
      ...
      <PageSubText align="left">
        실명인증을 위한 신용정보조회는 고객님의 개인신용평점에 영향을 주지
        않습니다.
      </PageSubText>
    </PageHead>
