    ...
    datas: [
      ...
      },
      {
        ...
        log: [
          ...
          {
            date: '2023.08.14',
            text: '- Agent_P02_l002 정렬 수정, x버튼 라인 삭제, 내구재선취수수료율 → 내구재물품기본금리로 수정\n- Agent_P02_l004 정렬 수정, x버튼 라인 삭제, 스크립트 내용 한줄만 노출\n- Agent_P02_l005 정렬 수정, x버튼 라인 삭제, byte 계산 추가\n- Agent_P02_l006 정렬 수정, x버튼 라인 삭제, byte 계산 추가\n- Agent_P02_l007 정렬 수정, x버튼 라인 삭제, byte 계산 추가',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        log: [
          {
            date: '2023.08.14',
            text: '신품여부 -> 납부방법 변경, 설립일자 / 대표업태 / 대표업종 추가, 전화번호 입력칸 변경',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        log: [
          {
            date: '2023.08.14',
            text: '- Agent_P03_l001 정렬 수정, x버튼 라인 삭제\n- Agent_P03_l002 정렬 수정, x버튼 라인 삭제, byte 계산 추가\n- Agent_P03_l003 정렬 수정, x버튼 라인 삭제, byte 계산 추가\n- Agent_P03_l004 정렬 수정, x버튼 라인 삭제, byte 계산 추가, 하나캐피탈 전자 약정 URL 발송 -> 하나캐피탈 전자 약정 URL 전송으로 수정',
          },
        ],
      },
      {
