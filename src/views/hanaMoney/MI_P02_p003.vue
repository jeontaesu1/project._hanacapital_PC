...
<template>
  <PageContents>
    ...
    <FormList>
      <FormListItem titleText="이메일" target="#MI_P02_p003_EmailId">
        <FormInvalid :error="state.mailError">
          <InputBlock :error="state.mailError">
            <InputBlockCell :flexible="true">
              <BasicInput title="이메일 아이디" id="MI_P02_p003_EmailId" />
            </InputBlockCell>
    ...
    <section class="row-margin-block-small row-margin-bottom-none">
      ...
      <FormList>
        <FormListItem
          titleText="사번입력"
          target="#MI_P02_p003_RecommenderNumber"
        >
            ...
            <InputBlock :error="state.recommenderNumberError">
              <InputBlockCell :flexible="true">
                <BasicInput
                  ...
                  pattern="\d*"
                  title="사번입력"
                  id="MI_P02_p003_RecommenderNumber"
                />
              </InputBlockCell>
            </InputBlock>
            <FormInvalidMessage>Error Message</FormInvalidMessage>
                  ...
                  <div :class="[$style['agree-list__contents']]">
                    ...
                    >
                      <li :class="$style['agree-list__item']">
                        <div :class="$style['agree-list__head']">
                          <CheckBox
                            id="MI_P02_p003Agree001_005_001"
                            :classNames="{
                              wrap: $style['agree-list__checkbox'],
                            }"
                            theme="quinary"
                      ...
                      <li :class="$style['agree-list__item']">
                        <div :class="$style['agree-list__head']">
                          <CheckBox
                            id="MI_P02_p003Agree001_005_002"
                            :classNames="{
                              wrap: $style['agree-list__checkbox'],
                            }"
                            theme="quinary"
                      ...
                      <li :class="$style['agree-list__item']">
                        <div :class="$style['agree-list__head']">
                          <CheckBox
                            id="MI_P02_p003Agree001_005_003"
                            :classNames="{
                              wrap: $style['agree-list__checkbox'],
                            }"
                            theme="quinary"
                      ...
                      <li :class="$style['agree-list__item']">
                        <div :class="$style['agree-list__head']">
                          <CheckBox
                            id="MI_P02_p003Agree001_005_004"
                            :classNames="{
                              wrap: $style['agree-list__checkbox'],
                            }"
                            theme="quinary"
...
@import '@/assets/scss/views/hanaMoney/MI_P02_p003.scss';
</style>
