    ...
    <ModalPopup>
      <template v-slot:head>
        <ModalPopupHead>
          ...
          <PopupTitle>구비서류 추가등록</PopupTitle>
        </ModalPopupHead>
      </template>
      ...
      <template v-slot:foot>
        ...
        >
          <ButtonListItem>
            <BasicButton size="regular">서류등록</BasicButton>
          </ButtonListItem>
        </ButtonList>
      </template>
    </ModalPopup>
...
@import '@/assets/scss/views/inventoryFinance/IF_P05_l001.scss';
</style>
