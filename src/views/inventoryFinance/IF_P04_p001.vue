  ...
  <PageContents>
    ...
    <div>
      ...
      <section>
        ...
        <FormList>
          <FormListItem titleText="차량번호" target="#IF_P04_p001_carNumber">
            <FormInvalid :error="state.carNumberError">
              <InputBlock :error="state.carNumberError">
                <InputBlockCell :flexible="true">
                  <BasicInput title="차량번호" id="IF_P04_p001_carNumber" />
                </InputBlockCell>
              </InputBlock>
            ...
            <FormInvalid :error="state.dateError">
              <BoxCheckList :classNames="{ wrap: 'row-margin-contents-small' }">
                <BoxCheckListItem>
                  <BoxCheck
                    :minSide="true"
                    name="IF_P04_p001_dateCheck"
                    id="IF_P04_p001_dateCheck001"
                  >
              ...
              <InputBlock :error="state.dateError">
                <InputBlockCell :flexible="true">
                  <BasicDatepicker
                    title="조회기간 시작 날짜"
                    id="IF_P04_p001_dateStart"
                    buttonId="IF_P04_p001_dateStartButton"
                ...
                <InputBlockCell :flexible="true" margin="regular">
                  <BasicDatepicker
                    title="조회기간 종료 날짜"
                    id="IF_P04_p001_dateEnd"
                    buttonId="IF_P04_p001_dateEndButton"
    ...
    <section class="contents-wrap">
      <h3 class="text-title-1 row-margin-contents">대출내역</h3>
            ...
            <BasicBox>
              <BasicBoxHead>
                <BasicBoxHeadLeft>
                  ...
                  <p
                    class="text-body-3 row-margin-item-small color-gray-tertiary"
                  >
