...
<template>
  <PageContents>
    <PageHead>
      <PageHeadRow>
        <PageTitle align="left">회원가입</PageTitle>
...
@import '@/assets/scss/views/sign/Member_P05_p001.scss';
</style>
