...
<template>
  <PageContents>
    <IllustInfo>
      ...
      <IllustInfoTitle
        >김하나님의 아이디는
        <span class="color-green">hana123</span>입니다</IllustInfoTitle
      >
      <IllustInfoText>로그인 후 홈페이지를 이용해 주세요.</IllustInfoText>
    </IllustInfo>

    <ButtonList :wrap="true" align="center">
      <ButtonListItem>
        <BasicButton tagName="RouterLink" to="">로그인</BasicButton>
      </ButtonListItem>
    </ButtonList>
  </PageContents>
</template>
