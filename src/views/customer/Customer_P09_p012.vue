        ...
        <table>
          ...
          <tbody>
            <tr v-for="i in 5" :key="i">
              ...
              <td>
                <RouterLink
                  to="/customer/Customer_P09_p013"
                  :class="$style['board__link']"
                >
                  <span :class="$style['board__title']"> $제목 노출$ </span>
                </RouterLink>
              </td>
              <td>
...
@import '@/assets/scss/views/customer/Customer_P09_p012.scss';
</style>
