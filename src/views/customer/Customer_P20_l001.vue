    ...
    <ModalPopup>
      <template v-slot:head>
        <ModalPopupHead>
          ...
          <PopupTitle>하나캐피탈 임직원 조회</PopupTitle>
          <template v-slot:sub>
            <PopupSubTitle>
              하나캐피탈의 임직원(방문판매인)만 조회됩니다.
            </PopupSubTitle>
          </template>
        </ModalPopupHead>
      </template>
      ...
      <div :class="$style['contents-wrap']">
        <FormList>
          <FormListItem titleText="이름" target="#Customer_P20_l001_name">
            <FormInvalid :error="state.nameError">
              <InputBlock :error="state.nameError">
                <InputBlockCell :flexible="true">
                  <BasicInput title="이름" id="Customer_P20_l001_name" />
                </InputBlockCell>
              </InputBlock>
          ...
          <FormListItem
            titleText="휴대폰 뒤 4자리"
            target="#Customer_P20_l001_phone"
          >
          ...
          <li class="row-margin-contents">
            <BasicBox>
              ...
              <KeyValue verticalAlign="center">
                ...
                <KeyValueItem>
                  <KeyValueTitle>내선번호</KeyValueTitle>
...
@import '@/assets/scss/views/customer/Customer_P20_l001.scss';
</style>
