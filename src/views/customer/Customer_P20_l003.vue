    ...
    <ModalPopup>
      <template v-slot:head>
        <ModalPopupHead>
          ...
          <PopupTitle>하나캐피탈 전화권유 판매원 조회</PopupTitle>
          <template v-slot:sub>
            <PopupSubTitle>
              하나캐피탈 TM모집법인 소속 직원만 검색됩니다.
            </PopupSubTitle>
          </template>
        </ModalPopupHead>
      </template>
      ...
      <div :class="$style['contents-wrap']">
        <FormList>
          <FormListItem titleText="이름" target="#Customer_P20_l003_name">
            <FormInvalid :error="state.nameError">
              <InputBlock :error="state.nameError">
                <InputBlockCell :flexible="true">
                  <BasicInput title="이름" id="Customer_P20_l003_name" />
                </InputBlockCell>
              </InputBlock>
...
@import '@/assets/scss/views/customer/Customer_P20_l003.scss';
</style>
